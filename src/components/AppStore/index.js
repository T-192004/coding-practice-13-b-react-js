...
class AppStore extends Component {
  ...
  getTabItemsAppList = searchAppList => {
    const {activeTabId} = this.state
    const filteredTabAppList = searchAppList.filter(
      eachApp => eachApp.category === activeTabId,
    )
    return filteredTabAppList
  }
  ...
  render() {
    ...
    const searchAppList = this.getSearchAppList()
    const filteredTabAppList = this.getTabItemsAppList(searchAppList)
      ...
      <div className="app-contianer">
        ...
        <div>
          <ul className="app-item-container">
            {filteredTabAppList.map(eachApp => (
